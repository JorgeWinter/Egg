...
//  System.out.println(pulgService.buscarPorId("0f065f5d-8bf5-43e8-9538-d2c01f684796"));;
    ...
    pulgas.add(pulgService.crearPulga("BeLuciana II"));
    pulgas.add(pulgService.crearPulga("Belu II"));
    pulgas.add(pulgService.crearPulga("Mari II"));
    pulgas.add(pulgService.crearPulga("Cocco II"));

    Mascota m = mascotaService.crearMascota("Chiqui", pulgas);
